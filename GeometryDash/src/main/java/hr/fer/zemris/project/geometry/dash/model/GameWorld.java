...
//        levelObjects.add(new GrassSpike(new Vector2D(GameConstants.playerPosition_X + 22 * GameConstants.iconHeight,  GameConstants.floorPosition_Y- 3 * GameConstants.iconHeight), GameConstants.grassImage));
//        levelObjects.add(new GrassSpike(new Vector2D(GameConstants.playerPosition_X + 18 * GameConstants.iconHeight, GameConstants.floorPosition_Y- 2 * GameConstants.iconHeight), GameConstants.grassImage));
...
//        levelObjects.add(new Spike(new Vector2D(GameConstants.playerPosition_X+50*GameConstants.iconHeight, GameConstants.floorPosition_Y), GameConstants.spikeImage));
//        levelObjects.add(new Spike(new Vector2D(GameConstants.playerPosition_X+55*GameConstants.iconHeight, GameConstants.floorPosition_Y), GameConstants.spikeImage));
//        levelObjects.add(new Spike(new Vector2D(GameConstants.playerPosition_X+60*GameConstants.iconHeight, GameConstants.floorPosition_Y), GameConstants.spikeImage));
...
//        levelObjects.add(new Block(new Vector2D(GameConstants.playerPosition_X + 34 * GameConstants.iconHeight, GameConstants.floorPosition_Y), GameConstants.blockImage));
//        levelObjects.add(new Block(new Vector2D(GameConstants.playerPosition_X + 35 * GameConstants.iconHeight, GameConstants.floorPosition_Y), GameConstants.blockImage));
//        levelObjects.add(new Spike(new Vector2D(GameConstants.playerPosition_X + 40 * GameConstants.iconHeight, GameConstants.floorPosition_Y - 3 * GameConstants.iconHeight), GameConstants.spikeImage));
//        levelObjects.add(new Spike(new Vector2D(GameConstants.playerPosition_X + 50 * GameConstants.iconHeight, GameConstants.floorPosition_Y), GameConstants.spikeImage));
//        levelObjects.add(new Spike(new Vector2D(GameConstants.playerPosition_X + 55 * GameConstants.iconHeight, GameConstants.floorPosition_Y), GameConstants.spikeImage));
//        levelObjects.add(new Spike(new Vector2D(GameConstants.playerPosition_X + 60 * GameConstants.iconHeight, GameConstants.floorPosition_Y), GameConstants.spikeImage));
...
//        levelObjects.add(new Spike(new Vector2D(GameConstants.playerPosition_X + 32 * GameConstants.iconHeight, GameConstants.floorPosition_Y - GameConstants.iconHeight), GameConstants.spikeImage));
//        levelObjects.add(new Spike(new Vector2D(GameConstants.playerPosition_X + 31 * GameConstants.iconHeight, GameConstants.floorPosition_Y), GameConstants.spikeImage));
...
//        levelObjects.add(new Spike(new Vector2D(GameConstants.playerPosition_X + 15 * GameConstants.iconHeight, GameConstants.floorPosition_Y- 3 * GameConstants.iconHeight), GameConstants.spikeImage));
//        levelObjects.add(new Spike(new Vector2D(GameConstants.playerPosition_X + 10 * GameConstants.iconHeight, GameConstants.floorPosition_Y), GameConstants.spikeImage));
//        levelObjects.add(new Spike(new Vector2D(GameConstants.playerPosition_X + 5 * GameConstants.iconHeight, GameConstants.floorPosition_Y- GameConstants.iconHeight), GameConstants.spikeImage));
