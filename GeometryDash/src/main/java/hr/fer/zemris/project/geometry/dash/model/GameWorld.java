...
public class GameWorld {
    ...
    private void createScene() {
        ...
        levelObjects.add(new GrassSpike(new Vector2D(GameConstants.playerPosition_X + 26 * GameConstants.iconHeight, GameConstants.floorPosition_Y + 3), GameConstants.grassImage));
        levelObjects.add(new GrassSpike(new Vector2D(GameConstants.playerPosition_X + 15 * GameConstants.iconHeight, GameConstants.floorPosition_Y + 3), GameConstants.grassImage));
        levelObjects.add(new Block(new Vector2D(GameConstants.playerPosition_X + 4 * GameConstants.iconHeight, GameConstants.floorPosition_Y + 3), GameConstants.blockImage));
        levelObjects.add(new Block(new Vector2D(GameConstants.playerPosition_X + 5 * GameConstants.iconHeight, GameConstants.floorPosition_Y + 3), GameConstants.blockImage));
        levelObjects.add(new Block(new Vector2D(GameConstants.playerPosition_X + 6 * GameConstants.iconHeight, GameConstants.floorPosition_Y + 3), GameConstants.blockImage));
        levelObjects.add(new Block(new Vector2D(GameConstants.playerPosition_X + 7 * GameConstants.iconHeight, GameConstants.floorPosition_Y + 3), GameConstants.blockImage));
        levelObjects.add(new Block(new Vector2D(GameConstants.playerPosition_X + 8 * GameConstants.iconHeight, GameConstants.floorPosition_Y + 3), GameConstants.blockImage));
//        levelObjects.add(new GrassSpike(new Vector2D(GameConstants.playerPosition_X + 40 * GameConstants.iconHeight, GameConstants.floorPosition_Y + 3), GameConstants.grassImage));
//        levelObjects.add(new GrassSpike(new Vector2D(GameConstants.playerPosition_X + 41 * GameConstants.iconHeight, GameConstants.floorPosition_Y + 3), GameConstants.grassImage));
//        levelObjects.add(new GrassSpike(new Vector2D(GameConstants.playerPosition_X + 42 * GameConstants.iconHeight, GameConstants.floorPosition_Y + 3), GameConstants.grassImage));
//        levelObjects.add(new GrassSpike(new Vector2D(GameConstants.playerPosition_X + 43 * GameConstants.iconHeight, GameConstants.floorPosition_Y + 3), GameConstants.grassImage));
        levelObjects.add(new Platform(new Vector2D(GameConstants.playerPosition_X + 20 * GameConstants.iconHeight, GameConstants.floorPosition_Y + 3 - GameConstants.iconHeight), GameConstants.iconWidth, GameConstants.platformImage));
        levelObjects.add(new Platform(new Vector2D(GameConstants.playerPosition_X + 21 * GameConstants.iconHeight, GameConstants.floorPosition_Y + 3 - GameConstants.iconHeight), GameConstants.iconWidth, GameConstants.platformImage));
        levelObjects.add(new Platform(new Vector2D(GameConstants.playerPosition_X + 22 * GameConstants.iconHeight, GameConstants.floorPosition_Y + 3 - GameConstants.iconHeight), GameConstants.iconWidth, GameConstants.platformImage));
        levelObjects.add(new Platform(new Vector2D(GameConstants.playerPosition_X + 23 * GameConstants.iconHeight, GameConstants.floorPosition_Y + 3 - GameConstants.iconHeight), GameConstants.iconWidth, GameConstants.platformImage));
        levelObjects.add(new Platform(new Vector2D(GameConstants.playerPosition_X + 24 * GameConstants.iconHeight, GameConstants.floorPosition_Y + 3 - GameConstants.iconHeight), GameConstants.iconWidth, GameConstants.platformImage));
        ...
        levelObjects.add(new Spike(new Vector2D(GameConstants.playerPosition_X+40*GameConstants.iconHeight, GameConstants.floorPosition_Y + 3), GameConstants.spikeImage));
        levelObjects.add(new GrassSpike(new Vector2D(GameConstants.playerPosition_X+50*GameConstants.iconHeight, GameConstants.floorPosition_Y + 3), GameConstants.grassImage));
        levelObjects.add(new GrassSpike(new Vector2D(GameConstants.playerPosition_X+55*GameConstants.iconHeight, GameConstants.floorPosition_Y + 3), GameConstants.grassImage));
        levelObjects.add(new GrassSpike(new Vector2D(GameConstants.playerPosition_X+60*GameConstants.iconHeight, GameConstants.floorPosition_Y + 3), GameConstants.grassImage));
        levelObjects.add(new GrassSpike(new Vector2D(GameConstants.playerPosition_X + 65 * GameConstants.iconHeight, GameConstants.floorPosition_Y + 3), GameConstants.grassImage));
        levelObjects.add(new GrassSpike(new Vector2D(GameConstants.playerPosition_X + 69 * GameConstants.iconHeight, GameConstants.floorPosition_Y + 3), GameConstants.grassImage));
        levelObjects.add(new GrassSpike(new Vector2D(GameConstants.playerPosition_X + 75 * GameConstants.iconHeight, GameConstants.floorPosition_Y + 3), GameConstants.grassImage));
        levelObjects.add(new GrassSpike(new Vector2D(GameConstants.playerPosition_X + 80 * GameConstants.iconHeight, GameConstants.floorPosition_Y + 3), GameConstants.grassImage));
        levelObjects.add(new Platform(new Vector2D(GameConstants.playerPosition_X + 30 * GameConstants.iconHeight, GameConstants.floorPosition_Y + 3 - GameConstants.iconHeight), GameConstants.iconWidth, GameConstants.platformImage));
        levelObjects.add(new Platform(new Vector2D(GameConstants.playerPosition_X + 31 * GameConstants.iconHeight, GameConstants.floorPosition_Y + 3 - GameConstants.iconHeight), GameConstants.iconWidth, GameConstants.platformImage));
        levelObjects.add(new Platform(new Vector2D(GameConstants.playerPosition_X + 32 * GameConstants.iconHeight, GameConstants.floorPosition_Y + 3 - GameConstants.iconHeight), GameConstants.iconWidth, GameConstants.platformImage));
        levelObjects.add(new Platform(new Vector2D(GameConstants.playerPosition_X + 33 * GameConstants.iconHeight, GameConstants.floorPosition_Y + 3 - GameConstants.iconHeight), GameConstants.iconWidth, GameConstants.platformImage));
        levelObjects.add(new Platform(new Vector2D(GameConstants.playerPosition_X + 34 * GameConstants.iconHeight, GameConstants.floorPosition_Y + 3 - GameConstants.iconHeight), GameConstants.iconWidth, GameConstants.platformImage));
        levelObjects.add(new Block(new Vector2D(GameConstants.playerPosition_X + 30 * GameConstants.iconHeight, GameConstants.floorPosition_Y + 3), GameConstants.blockImage));
        levelObjects.add(new Block(new Vector2D(GameConstants.playerPosition_X + 31 * GameConstants.iconHeight, GameConstants.floorPosition_Y + 3), GameConstants.blockImage));
        levelObjects.add(new Block(new Vector2D(GameConstants.playerPosition_X + 34 * GameConstants.iconHeight, GameConstants.floorPosition_Y + 3), GameConstants.blockImage));
        levelObjects.add(new Block(new Vector2D(GameConstants.playerPosition_X + 35 * GameConstants.iconHeight, GameConstants.floorPosition_Y + 3), GameConstants.blockImage));
        ...
        levelObjects.add(new LeftSpike(new Vector2D(GameConstants.playerPosition_X + 32 * GameConstants.iconHeight, GameConstants.floorPosition_Y + 3 - GameConstants.iconHeight), GameConstants.leftSpikeImage));
        levelObjects.add(new LeftSpike(new Vector2D(GameConstants.playerPosition_X + 31 * GameConstants.iconHeight, GameConstants.floorPosition_Y + 3), GameConstants.leftSpikeImage));
...
//        levelObjects.add(new Spike(new Vector2D(GameConstants.playerPosition_X + 20 * GameConstants.iconHeight, GameConstants.floorPosition_Y + 3), GameConstants.spikeImage));
        levelObjects.add(new Spike(new Vector2D(GameConstants.playerPosition_X + 12 * GameConstants.iconHeight, GameConstants.floorPosition_Y + 3), GameConstants.spikeImage));
